...
if __name__ == "__main__":
    ...
    scheduler = optim.lr_scheduler.CyclicLR(optimizer, base_lr=min_lr, max_lr=max_lr, mode='triangular2', gamma=0.9, cycle_momentum=False, step_size_up=learn_step_size, step_size_down=learn_step_size) # last_epoch=learn_step_size - 1, uncomment to swap order 
